...
const AAA = (props: AProps) => {
  return <div className={props.className}>{props.children}</div>;
};

const Wrapper = styled(AAA)`
  .theme-switch {
    --toggle-size: ${(props) => props.size || "12px"};
...
export default function DarkmodeSwitch(props: SwitchProps) {
  const { darkmode, setDarkmode } = useMobileAppStore();
  return (
    <Wrapper size={props.size || "12px"}>
